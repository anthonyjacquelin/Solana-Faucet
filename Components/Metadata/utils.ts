...
export const refreshBalance = async (
  ...
  try {
    ...
    console.log("publicKey refreshBalance: ", publicKey);
...
export const sendTransaction = async (
  ...
  // send transaction through the network
  const connection = new Connection(clusterApiUrl(network), "confirmed");

  console.log("sending ", amount * LAMPORTS_PER_SOL, "lamports to ", receiver);
...
export const handleAirdrop = async (
  ...
  console.log("publicKey handleAirdrop: ", publicKey);
  ...
  const confirmation = await connection
    ...
    .then((conf) => {
      console.log("Airdrop complete", conf);
    })
    .catch((err) => {
